...
String filePathLembaga = projectDir + GlobalVariable.fileUpload

TestObject uploadFileLembaga = new TestObject()
uploadFileLembaga.addProperty('xpath', ConditionType.EQUALS, '//input[@type="file"]')

WebUI.uploadFile(uploadFileLembaga, filePathLembaga)
