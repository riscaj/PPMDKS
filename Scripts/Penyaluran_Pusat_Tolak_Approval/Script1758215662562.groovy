...
WebUI.setText(inputPIC, 'Marisca_9')

TestObject optionPIC = new TestObject('optionPIC')
optionPIC.addProperty('xpath', ConditionType.EQUALS, '//li[contains(@class,\'vs__dropdown-option\') and contains(text(),\'Marisca_9\')]')
...
WebUI.setText(inputLembaga, 'Yayasan Angkasa17')

TestObject optionLembaga = new TestObject('optionLembaga')
optionLembaga.addProperty('xpath', ConditionType.EQUALS, '//li[contains(@class,\'vs__dropdown-option\') and normalize-space(text())=\'Yayasan Angkasa17\']')
