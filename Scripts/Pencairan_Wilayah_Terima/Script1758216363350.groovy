...
WebElement el = WebUiCommonHelper.findWebElement(menuPenyaluranWilayah, 10)
JavascriptExecutor js = ((DriverFactory.getWebDriver()) as JavascriptExecutor)

js.executeScript('arguments[0].click();', el)

TestObject submenuPengajuan = new TestObject('submenuPengajuan')
submenuPengajuan.addProperty('xpath', ConditionType.EQUALS, '//li[contains(@class,\'has-sub\') and .//span[normalize-space(text())=\'Penyaluran Wilayah\']]//ul//span[normalize-space(text())=\'Pengajuan\']')
...
WebUI.setText(inputPIC, 'Marisca_4')

TestObject optionPIC = new TestObject('optionPIC')
optionPIC.addProperty('xpath', ConditionType.EQUALS, '//li[contains(@class,\'vs__dropdown-option\') and contains(text(),\'Marisca_4\')]')
...
WebUI.setText(inputLembaga, 'Yayasan_4')

TestObject optionLembaga = new TestObject('optionLembaga')
optionLembaga.addProperty('xpath', ConditionType.EQUALS, '//li[contains(@class,\'vs__dropdown-option\') and normalize-space(text())=\'Yayasan_4\']')
...
submenuVerifikasiBerkas.addProperty('xpath', ConditionType.EQUALS, '//li[contains(@class,\'has-sub\') and .//span[normalize-space(text())=\'Penyaluran Wilayah\']]//ul//span[normalize-space(text())=\'Verifikasi Berkas\']')
...
submenuSurveyLokasi.addProperty('xpath', ConditionType.EQUALS, '//li[contains(@class,\'has-sub\') and .//span[normalize-space(text())=\'Penyaluran Wilayah\']]//ul//span[normalize-space(text())=\'Survey Lokasi\']')
...
submenuRekomendasi.addProperty('xpath', ConditionType.EQUALS, '//li[contains(@class,\'has-sub\') and .//span[normalize-space(text())=\'Penyaluran Wilayah\']]//ul//span[normalize-space(text())=\'Rekomendasi\']')
...
//Approval Deputi Operasional
TestObject submenuApprovalDeputiOperasional = new TestObject('submenuApprovalDeputiOperasional')
submenuApprovalDeputiOperasional.addProperty('xpath', ConditionType.EQUALS, '//li[contains(@class,\'has-sub\') and .//span[normalize-space(text())=\'Penyaluran Wilayah\']]//ul//span[normalize-space(text())=\'Approval Deputi Operasional\']')
...
WebUI.waitForElementVisible(btnApproveDeputiOperasional, 20)
WebUI.click(btnApproveDeputiOperasional)
...
submenuUMP.addProperty('xpath', ConditionType.EQUALS, '//li[contains(@class,\'has-sub\') and .//span[normalize-space(text())=\'Penyaluran Wilayah\']]//ul//span[normalize-space(text())=\'UMP\']')
...
WebUI.waitForElementVisible(inputSearchPajak, 20)
...
WebUI.waitForElementVisible(inputSearchPPN, 20)
...
WebUI.waitForElementVisible(NilaiPPN, 20)
...
WebUI.waitForElementVisible(inputSearchPPH, 20)
...
WebUI.waitForElementVisible(NilaiPPH, 20)
...
WebUI.click(buttonSetujuiAppPencairan)

WebUI.click(findTestObject('Object Repository/Page_PPMDKS/button_Ya, Simpan'))

TestObject closeBtnApprovalPencairan = new TestObject()
closeBtnApprovalPencairan.addProperty('xpath', ConditionType.EQUALS, '//button[normalize-space()=\'Tutup\']')
...
WebUI.setText(dropdownBaganAkun, 'Wilayah 2 Pekanbaru')

TestObject optionBaganAkun = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//li[contains(@id,\'vs\') and normalize-space()=\'Wilayah 2 Pekanbaru\']')
